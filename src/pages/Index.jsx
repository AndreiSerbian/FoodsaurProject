  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-10 max-w-xl mx-auto mb-12">
          <div className="relative">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-green-500"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {filteredCategories.length > 0 ? (
              ...
              >
                <Card className="p-6 h-full bg-white/80 backdrop-blur-sm border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300">
                  <div className="space-y-4">
                    <div className="h-48 rounded-lg bg-gray-100 flex items-center justify-center overflow-hidden">
                      <img 
            ...
            <div className="col-span-4 text-center py-10">
              <p className="text-xl text-gray-600">Категорий не найдено</p>
            </div>
          )}
        </div>
      </div>
